...
/* harmony export */   "onClickIcons": () => (/* binding */ onClickIcons),
/* harmony export */   "onWindowScroll": () => (/* binding */ onWindowScroll),
/* harmony export */   "scrollPageToBlock": () => (/* binding */ scrollPageToBlock)
/* harmony export */ });
...
function checkScrollForHeaderItems(item, i, arr) {
  ...
  if (window.pageYOffset >= getScrollOffset(item.textContent) && window.pageYOffset < getScrollOffset(arr[i + 1].textContent)) {
...
function getScrollOffset(name) {
  return document.querySelector("[data-".concat(name.toLowerCase(), "]")).offsetTop - 60;
}
...
/* harmony export */   "clearModalAfterSubmit": () => (/* binding */ clearModalAfterSubmit),
/* harmony export */   "hideModal": () => (/* binding */ hideModal),
/* harmony export */   "modal": () => (/* binding */ modal),
/* harmony export */   "removeErrorHighlight": () => (/* binding */ removeErrorHighlight),
...
var firstShow = true;
var modalFirstShow = setTimeout(showModal, 10000);
...
function clearModalAfterSubmit(e, selector, defaultText) {
  console.log(345);
  var hidingTimeout = setTimeout(function () {
    hiding();
    clearTimeout(hidingTimeout);
    document.querySelector("".concat(selector, " .subtitle")).textContent = defaultText; // document.querySelector(`${selector} .button`).removeAttribute('disabled');
  }, 1500);
}
...
function validateFields(selector) {
  var correct = true;
  var inputFields = document.querySelectorAll("".concat(selector, " .form__item")),
      textareaField = document.querySelector("".concat(selector, " .form__textarea")),
      inputErrorFields = document.querySelectorAll("".concat(selector, " .form__error-text")),
  ...
  var requestCallback = function requestCallback(text) {
    document.querySelector("".concat(selector, " .subtitle")).textContent = text;
    clearFields([].concat(_toConsumableArray(inputFields), [textareaField]));
  };
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            throw new Error("Couldn't fetch URL ".concat(url));
...
function _sendData() {
  _sendData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(url, data) {
    var response;
...
function changeSlide(length, idx) {
  sliderContainer.style.cssText = "\n        transform: translateX(-".concat(length * idx, "px);\n        transition: .5s;\n    ");
...
var semicolonsElement = document.querySelectorAll('.timer span'),
...
var endTime = new Date('June 1, 2022 14:00:00');
var currColor = 'white',
    iterCounter = 0;
...
function createTimer() {
  var changeTime = setInterval(function () {
    ...
    var difference = Math.floor((endTime - currTime) / 1000);
    var minutes = formatTime(difference / 60 % 60);
    minutesElement.textContent = minutes;

    if (minutes > 0) {
      currColor = currColor === 'white' ? 'transparent' : 'white';
      semicolonsElement.forEach(function (item) {
        return item.style.color = currColor;
      });

      if (iterCounter / 60000 === 0) {
        var hours = formatTime(difference / 60 / 60 % 24);
        var days = formatTime(difference / 60 / 60 / 24);
...
/* harmony import */ var _src_scripts_modal_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./src/scripts/modal.js */ "./src/scripts/modal.js");
/* harmony import */ var _src_scripts_header_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./src/scripts/header.js */ "./src/scripts/header.js");
/* harmony import */ var _src_scripts_slider_js__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./src/scripts/slider.js */ "./src/scripts/slider.js");
/* harmony import */ var _src_scripts_timer_js__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./src/scripts/timer.js */ "./src/scripts/timer.js");
/* harmony import */ var _src_scripts_request_js__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./src/scripts/request.js */ "./src/scripts/request.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  inputElements.forEach(_src_scripts_modal_js__WEBPACK_IMPORTED_MODULE_16__.removeErrorHighlight);
  textareaElements.forEach(_src_scripts_modal_js__WEBPACK_IMPORTED_MODULE_16__.removeErrorHighlight);
  headerItems[4].addEventListener('click', _src_scripts_modal_js__WEBPACK_IMPORTED_MODULE_16__.showModal);
  _src_scripts_modal_js__WEBPACK_IMPORTED_MODULE_16__.modal.addEventListener('mousedown', function (e) {
    return (0,_src_scripts_modal_js__WEBPACK_IMPORTED_MODULE_16__.hideModal)(e);
  });

  function makeRequestWithFormData(e) {
    ...
    var _validateFields = (0,_src_scripts_modal_js__WEBPACK_IMPORTED_MODULE_16__.validateFields)(args[0]),
        _validateFields2 = _slicedToArray(_validateFields, 2),
        correct = _validateFields2[0],
        requestCallback = _validateFields2[1];

    if (correct) {
      // document.querySelector(`${args[0]} .button`).setAttribute('disabled', '');
      var data = new FormData(this);
      var json = JSON.stringify(Object.fromEntries(data.entries()));
      (0,_src_scripts_request_js__WEBPACK_IMPORTED_MODULE_20__.sendData)('http://localhost:3000/feedback', json).then(function () {
        return requestCallback('Thank you! We will inform you about the results.');
      }).then(function () {
        return _src_scripts_modal_js__WEBPACK_IMPORTED_MODULE_16__.clearModalAfterSubmit.apply(void 0, [e].concat(args));
  ...
  modalForm.addEventListener('submit', function (e) {
    return makeRequestWithFormData.call(modalForm, e, '.modal', 'Have any ideas? Write here');
  });
  contactForm.addEventListener('submit', function (e) {
    return makeRequestWithFormData.call(contactForm, e, '.form', 'Fill in the details');
  }); // from header.js

  var bannerButton = document.querySelector('.banner .button');
  window.addEventListener('scroll', function () {
    return (0,_src_scripts_header_js__WEBPACK_IMPORTED_MODULE_17__.onWindowScroll)(headerItems);
  });
  (0,_src_scripts_header_js__WEBPACK_IMPORTED_MODULE_17__.changeHeader)();
  window.addEventListener("optimizedResize", _src_scripts_header_js__WEBPACK_IMPORTED_MODULE_17__.changeHeader);
  (0,_src_scripts_header_js__WEBPACK_IMPORTED_MODULE_17__.onClickIcons)();
  ...
  try {
    var _loop = function _loop() {
      ...
      item.addEventListener('click', function () {
        return (0,_src_scripts_header_js__WEBPACK_IMPORTED_MODULE_17__.scrollPageToBlock)(item);
      });
    };
  ...
  bannerButton.addEventListener('click', function (e) {
    e.preventDefault();
    (0,_src_scripts_header_js__WEBPACK_IMPORTED_MODULE_17__.scrollPageToBlock)(headerItems[0], true);
  }); // from slider.js

  var sliderRight = document.querySelector('.slider__arrow-right'),
      sliderLeft = document.querySelector('.slider__arrow-left'); // from request.js

  (0,_src_scripts_request_js__WEBPACK_IMPORTED_MODULE_20__.getData)('http://localhost:3000/dev_info').then(function (response) {
    (0,_src_scripts_slider_js__WEBPACK_IMPORTED_MODULE_18__.initSlider)(response);
  })["catch"](function (e) {
    return console.log(e);
  });
  sliderRight.addEventListener('click', _src_scripts_slider_js__WEBPACK_IMPORTED_MODULE_18__.scrollToRight);
  sliderLeft.addEventListener('click', _src_scripts_slider_js__WEBPACK_IMPORTED_MODULE_18__.scrollToLeft);
  _src_scripts_slider_js__WEBPACK_IMPORTED_MODULE_18__.sliderDots.forEach(_src_scripts_slider_js__WEBPACK_IMPORTED_MODULE_18__.scrollByDots); // from timer.js

  (0,_src_scripts_timer_js__WEBPACK_IMPORTED_MODULE_19__["default"])();
});
})();
